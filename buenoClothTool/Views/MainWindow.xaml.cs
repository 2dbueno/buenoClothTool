...
namespace buenoClothTool
{
    ...
    {
        public static string AppVersion => "Version: 1.0.0-private";
        ...
        {
            { "import", "buenoClothTool_import" },
            { "export", "buenoClothTool_export" },
            { "dragdrop", "buenoClothTool_dragdrop" }
        };
        ...
        public async Task<bool> ImportProjectAsync(bool shouldSetProjectName = false)
        {
            ...
            OpenFileDialog openFileDialog = new()
            {
                ...
                Filter = "buenoClothTool project (*.gctproject)|*.gctproject"
            };
