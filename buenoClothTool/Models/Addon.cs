    ...
    public Addon(string name)
    {
        ...
        if (name == "design")
        {
            for (int i = 1; i < 50; i++)
            {
                ...
                Drawables.Add(
                    new GDrawable(Guid.Empty, "buenoClothTool/Assets/jbib_000_u.ydd", sexEnum, false, 11, i, false,
                    [
                        new(Guid.Empty, "buenoClothTool/Assets/jbib_diff_000_a_uni.ytd", 11, 0, 0, false, false),
                        new(Guid.Empty, "buenoClothTool/Assets/jbib_diff_000_a_uni.ytd", 11, 0, 1, false, false)
                    ]
                ));
            }
